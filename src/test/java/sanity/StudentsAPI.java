...
public class StudentsAPI extends CommonOps {
    ...
    @Test(description = "Test 01: Verify Get Students List From StudentsAPI")
    ...
    @Description("This Test Adds a Student to StudentsAPI and Verify it")
    ...
    @Description("This Test Update a Student in StudentsAPI and Verify it")
    public void test03UpdateStudentAndVerify(){
        String id = ApiFlows.getStudentProperty("[0].id");
        ApiFlows.putStudentProperty("Oren", "Berserk", "a16orenBerserk@gmail.com", "QA Automation", "101");
    ...
    @Description("This Test Deletes a Student in StudentsAPI and Verify it")
